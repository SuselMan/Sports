...
## Краткое описание:
Проект представляет из себя мобильное приложение + backend для записи силовых тренировок и отслеживания прогресса. Моя основная потребность как пользователя — зайти в приложение и просматривать историю упражнений и свой прогресс.
...
## Стек
Frontend: typescript (strict mode), react native (expo), UI Kitten, axios, zustand, lodash, dayjs  
